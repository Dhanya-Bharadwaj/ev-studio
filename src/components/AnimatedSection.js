...
export default function AnimatedSection({ heading, text, image, reverse = false }) {
  const textVariants = {
    ...
    visible: {
      ...
      transition: {
        duration: 0.9,
        ease: [0.6, 0.05, -0.01, 0.9], // Custom cubic-bezier for a snappier feel
      },
    },
  };
  ...
  const imageVariants = {
    ...
    visible: {
      ...
      transition: {
        ...
        ease: [0.25, 0.46, 0.45, 0.94], // Custom cubic-bezier for a smooth bounce
      },
    },
  };
